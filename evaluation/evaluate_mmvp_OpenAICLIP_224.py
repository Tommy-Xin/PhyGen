...
if __name__ == "__main__":
    ...
    #vision_tower_name = '/home/gaiyiming/hjq/xinc/GenHancer/Continuous/outputs/output_CLIP_224_stage2_load100000_all_lr1e-5/clip-vit-large-patch14-5000'
    vision_tower_name = '/home/gaiyiming/hjq/xinc/GenHancer/Continuous/outputs/output_CLIP_seed99_224_stage2_load100000_all_lr1e-5_gradient_accumulation_4/clip-vit-large-patch14-5000'
    #only finetune some components
    #vision_tower_name = '/home/gaiyiming/hjq/xinc/GenHancer/Continuous/outputs/output_CLIP_224_stage2_load100000_only_lr1e-5/clip-vit-large-patch14-10000'
    # Load model from trained checkpoint
    vision_tower = CLIPModel.from_pretrained(vision_tower_name, device_map=device)
    
    # For trained models, processor and tokenizer may not be saved
    # Fall back to official model if not found in trained model directory
    #official_model_name = '/home/gaiyiming/hjq/xinc/GenHancer/Continuous/outputs/output_CLIP_seed99_224_stage2_load100000_all_lr1e-5/clip-vit-large-patch14-10000'
    
    # if os.path.isdir(vision_tower_name):
    #     # Try to load processor and tokenizer from trained model directory
    #     if os.path.exists(os.path.join(vision_tower_name, 'preprocessor_config.json')):
    #         image_processor = CLIPImageProcessor.from_pretrained(vision_tower_name)
    #     else:
    #         # Use official model's processor
    #         image_processor = CLIPImageProcessor.from_pretrained(official_model_name)
        
    #     if os.path.exists(os.path.join(vision_tower_name, 'tokenizer_config.json')):
    #         tokenizer = CLIPTokenizer.from_pretrained(vision_tower_name, max_length=77)
    #     else:
    #         # Use official model's tokenizer
    #         tokenizer = CLIPTokenizer.from_pretrained(official_model_name, max_length=77)
    # else:
    #     # HuggingFace repo ID, load everything from there
    #     image_processor = CLIPImageProcessor.from_pretrained(vision_tower_name)
    #     tokenizer = CLIPTokenizer.from_pretrained(vision_tower_name, max_length=77)
