...
accelerate launch --config_file "train_configs/accelerate_config.yaml" training/train_OpenAICLIP_stage1_meanflow.py --config "train_configs/test_OpenAICLIP_224_stage1_meanflow.yaml"
