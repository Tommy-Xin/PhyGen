...
from evaluation.evaluate_mmvp_SigLIP_384_eval import evaluate_checkpoint
from Continuous.add_processor_tokenizer import add_processor_tokenizer
                ...
                if eval_enabled and global_step % eval_steps == 0:
                    ...
                    if accelerator.is_main_process:
                        save_path = os.path.join(
                            args.output_dir,
                            f"siglip-so400m-patch14-{args.clip_config.clip_image_size}-{global_step}",
                        )
                        ...
                        try:
                            add_processor_tokenizer(
                                save_path,
                                base_model_path="/home/gaiyiming/hjq/xinc/GenHancer/Continuous/pretrained_weights/siglip-so400m-patch14-384",
                            )
                            ...
                            results_path = os.path.join(args.output_dir, "mmvp_siglip_384_eval_results.jsonl")
